...
export function AuthProvider({ children }) {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
      try {
        if (currentUser) {
          ...
          const justLoggedIn = await AsyncStorage.getItem("__INNERORBIT_JUST_LOGGED_IN");
          if (globalThis.__INNERORBIT_JUST_LOGGED_IN || justLoggedIn === 'true') {
            ...
            globalThis.__INNERORBIT_JUST_LOGGED_IN = false;
            await AsyncStorage.removeItem("__INNERORBIT_JUST_LOGGED_IN").catch(() => {});
          }
  ...
  const signUp = async (email, password) => {
    try {
      ...
      await AsyncStorage.setItem("__INNERORBIT_JUST_LOGGED_IN", "true");
      globalThis.__INNERORBIT_JUST_LOGGED_IN = true;
