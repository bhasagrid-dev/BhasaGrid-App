...
export default function SignUpScreen() {
  ...
  const validateInputs = () => {
    if (!ageConfirmed) {
      showError("You must confirm that you are at least 13 years old to use BhasaGrid.");
      return false;
    }
    if (!termsAccepted) {
              ...
              >
                ...
                <Text style={{
                  ...
                  <Text
                    ...
                    onPress={() => {
                      if (isWeb) {
                        window.open('https://bhasagrid-bc8ce.web.app/terms-of-service.html', '_blank');
                      } else {
                        import('expo-linking').then(({ default: Linking }) => {
                          Linking.openURL('https://bhasagrid-bc8ce.web.app/terms-of-service.html');
                        });
                      }
                    }}
                  >
                  ...
                  <Text
                    ...
                    onPress={() => {
                      if (isWeb) {
                        window.open('https://bhasagrid-bc8ce.web.app/privacy-policy.html', '_blank');
                      } else {
                        import('expo-linking').then(({ default: Linking }) => {
                          Linking.openURL('https://bhasagrid-bc8ce.web.app/privacy-policy.html');
                        });
                      }
                    }}
                  >
