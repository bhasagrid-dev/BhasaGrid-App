/**
 * 🔐 BHASAGRID CORE ENCRYPTION ENGINE
 * 
 * PURPOSE:
 * This module is the "Heart" of BhasaGrid's security. It manages how data is locked and unlocked 
...
/**
 * Enhanced Encryption utility module for BhasaGrid
...
const USER_PASSPHRASE_STORAGE = "bhasagrid_user_passphrase";
const PQC_PUBLIC_KEY_STORAGE = "bhasagrid_pqc_public_key";
const PQC_PRIVATE_KEY_STORAGE = "bhasagrid_pqc_private_key";
 ...
 */
const RATCHET_SESSION_PREFIX = "@bhasagrid_ratchet_";
