...
const SLIDES = [
    {
        ...
        description: 'BhasaGrid is a fully functional calculator that secretly houses a secure chat network. It looks innocent, so your privacy remains unquestioned.',
