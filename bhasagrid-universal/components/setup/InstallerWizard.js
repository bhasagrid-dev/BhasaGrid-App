...
const STEPS = [
    { id: 'welcome', title: 'Welcome to BhasaGrid', subtitle: 'Secure Communication Platform' },
        ...
        <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
            ...
            <View style={styles.content}>
                <View style={styles.logoContainer}>
                    <Image
                        source={require('../../assets/BhasaGrid-Logo.png')}
                        style={styles.logo}
                        resizeMode="contain"
                    />
                ...
                {currentStep === 3 ? (
                    ...
                    >
                        <Text style={styles.btnText}>Start BhasaGrid</Text>
                    </Pressable>
                ) : (
