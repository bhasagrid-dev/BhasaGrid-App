 ...
 *
 * The user enters their BhasaGrid PIN → the app derives the backup key
...
export default function PinRecoveryModal({
  ...
  const handleRestore = async () => {
    if (pin.length < 4) {
      setError("Enter your BhasaGrid PIN (4–6 digits)");
      shake();
      return;
    }
      ...
      <View style={styles.overlay}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            You're on a new device. Enter your BhasaGrid PIN to restore your
            message history.
          </Text>
