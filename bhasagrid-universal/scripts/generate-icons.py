...
if __name__ == "__main__":
    logo_path = "C:/BhasaGrid-Mobile-Web-App/BhasaGrid-Logo.png"
    assets_dir = "C:/BhasaGrid-Mobile-Web-App/BhasaGrid-universal/assets"
    ...
    build_dir = "C:/BhasaGrid-Mobile-Web-App/BhasaGrid-universal/build"
